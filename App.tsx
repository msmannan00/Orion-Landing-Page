...
const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    root.style.overflowX = 'hidden'; // Defensive overflow control
  ...
  return (
    <div className="min-h-screen mesh-gradient selection:bg-blue-500/30 overflow-x-hidden">
      ...
      <main className="relative z-10 w-full overflow-x-hidden">
        {view === 'adversaries' ? (
          <div className="pt-28 lg:pt-32 px-4 lg:px-12 max-w-[1400px] mx-auto min-h-screen">
            <ThreatActors />
          </div>
        ) : view === 'api-docs' ? (
          ...
          <>
            ...
            <section className="relative min-h-screen flex flex-col px-4 lg:px-12 overflow-hidden border-b border-slate-200 dark:border-white/5 pt-28 md:pt-0">
              ...
              <div className="max-w-[1400px] mx-auto w-full pb-12 flex flex-wrap items-center justify-center md:justify-between gap-6 md:gap-8 font-mono border-t border-slate-200 dark:border-white/5 pt-10 animate-in fade-in duration-1000 delay-500">
                {[
                  { label: 'Records', val: '14.2B+', color: 'text-blue-600 dark:text-blue-500' },
                  { label: 'Groups', val: '240+', color: 'text-slate-900 dark:text-white' },
                  { label: 'Throughput', val: '1.4TB', color: 'text-slate-900 dark:text-white' },
                  { label: 'Uptime', val: '99.98%', color: 'text-green-600 dark:text-green-500' }
                ].map((stat, i) => (
            ...
            <section id="core" className="px-4 lg:px-12 py-20 md:py-32 bg-slate-50 dark:bg-[#080808] relative">
              <div className="max-w-[1400px] mx-auto">
                <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-10 md:gap-16 mb-16 md:mb-24">
                  <div className="max-w-4xl space-y-4 md:space-y-8">
                    <div className="flex items-center gap-3">
                      ...
                      <h2 className="text-[10px] md:text-[12px] font-bold text-slate-400 dark:text-white/40 uppercase tracking-wider md:tracking-[0.4em]">Strategic Modular Core</h2>
                    </div>
                    <h3 className="text-3xl md:text-5xl font-extrabold text-slate-900 dark:text-white tracking-tight leading-none pb-2 break-words">Unified Defense Platform.</h3>
                  </div>
                  <div className="max-w-md space-y-4 md:space-y-6 border-l border-slate-200 dark:border-white/5 pl-6 md:pl-10">
                    <p className="text-base md:text-lg text-slate-500 dark:text-white/40 leading-relaxed font-medium">High-fidelity infrastructure for sovereign intelligence operations and organizational threat discovery.</p>
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                  {[
                    ...
                    <div key={i} className="group relative bg-white dark:bg-[#020202] border border-slate-200 dark:border-white/5 rounded-2xl p-6 md:p-8 flex flex-col h-full transition-all duration-500 hover:bg-slate-50 dark:hover:bg-[#0c0c0c] hover:-translate-y-1 hover:border-blue-500/20 shadow-sm dark:shadow-none hover:shadow-md">
                      ...
                      <div className="pt-6 border-t border-slate-100 dark:border-white/5 flex items-center justify-between">
                        <span className="text-[9px] md:text-[10px] font-bold text-slate-300 dark:text-white/20 uppercase tracking-widest">{f.footer}</span>
                        <ArrowRight className="w-4 h-4 text-slate-300 dark:text-white/10 group-hover:text-blue-600 dark:group-hover:text-blue-500 group-hover:translate-x-1 transition-all" />
                      </div>
                    </div>
                  ))}
                </div>
                 ...
                 <div className="glass-card rounded-[2rem] md:rounded-[3rem] p-8 md:p-12 lg:p-24 border border-slate-200 dark:border-white/5 relative overflow-hidden">
                   ...
                   <div className="grid lg:grid-cols-2 gap-12 md:gap-20 items-center">
                     <div className="space-y-8 md:space-y-10">
                        ...
                        <h2 className="text-3xl lg:text-4xl font-extrabold text-slate-900 dark:text-white tracking-tight leading-none pb-2 break-words">Secure Reporting System.</h2>
                     ...
                     <div className="relative">
                        <div className="aspect-square bg-slate-50 dark:bg-white/[0.01] border border-slate-200 dark:border-white/5 rounded-[2rem] flex items-center justify-center relative group overflow-hidden">
                           ...
                           <ShieldAlert className="w-32 h-32 md:w-48 md:h-48 text-slate-200 dark:text-white/[0.01] group-hover:text-blue-600/10 dark:group-hover:text-blue-500/10 transition-colors duration-1000" />
                           <div className="absolute inset-0 flex flex-col items-center justify-center p-8 md:p-12 text-center">
                              ...
                              <h4 className="text-lg md:text-xl font-bold text-slate-900 dark:text-white mb-3 md:mb-4 uppercase tracking-widest">Initialize Drop</h4>
            ...
            {/* Probe & Feed Section */}
            <section id="probe" className="px-4 lg:px-12 py-20 md:py-32 overflow-hidden relative bg-white dark:bg-[#050505] border-y border-slate-200 dark:border-white/5">
              <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-full h-[600px] bg-blue-500/[0.02] dark:bg-blue-500/[0.02] blur-[150px] pointer-events-none rounded-full"></div>
              <div className="max-w-[1400px] mx-auto relative z-10 w-full">
                <div className="text-center mb-12 md:mb-20 space-y-4 md:space-y-6 px-2">
                   ...
                   <h3 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-extrabold text-slate-900 dark:text-white tracking-tight leading-none pb-2 break-words">Intelligence Search.</h3>
                   <p className="text-base md:text-lg text-slate-400 dark:text-white/20 max-w-3xl mx-auto leading-relaxed">
            ...
            <section className="px-4 lg:px-12 py-20 md:py-32 bg-slate-50 dark:bg-[#0a0a0a]">
              <div className="max-w-[1400px] mx-auto">
                <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-10 md:gap-16 mb-16 md:mb-24">
                  <div className="max-w-4xl space-y-6 md:space-y-8">
                    <div className="flex flex-wrap items-center gap-4">
                      ...
                      <h2 className="text-[10px] md:text-[12px] font-bold text-slate-400 dark:text-white/40 uppercase tracking-[0.4em]">Administrative Governance</h2>
                    </div>
                    <h3 className="text-3xl md:text-5xl font-extrabold text-slate-900 dark:text-white tracking-tight leading-none pb-2 break-words">Central Control Plane.</h3>
                  </div>
                  <div className="max-w-md space-y-4 md:space-y-6 border-l border-slate-200 dark:border-white/5 pl-6 md:pl-10">
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                   {[
                     ...
                     <div key={i} className="glass-card p-8 md:p-10 rounded-3xl group hover:border-blue-600/20 dark:hover:border-blue-500/20 transition-all">
              ...
              <div className="max-w-[1400px] mx-auto flex flex-col items-center text-center relative z-10">
                 ...
                 <div className="space-y-4 md:space-y-6 mb-16 md:mb-20">
                    <h2 className="text-3xl md:text-6xl font-extrabold text-slate-900 dark:text-white tracking-tight pb-2 break-words">
                      <span className="text-transparent bg-clip-text bg-gradient-to-b from-slate-900 to-slate-400 dark:from-white dark:to-white/20">Operational Liaison.</span>
                    </h2>
                 ...
                 <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 w-full max-w-6xl mb-20 md:mb-24 text-left">
                    <div className="space-y-4 md:space-y-6 group/item">
                       <div className="flex items-center gap-3 text-[9px] md:text-[10px] font-black text-slate-400 dark:text-white/60 uppercase tracking-[0.2em] border-b border-slate-100 dark:border-white/5 pb-2 group-hover/item:border-blue-600/40 dark:group-hover/item:border-blue-500/40 transition-colors">
                          <Globe className="w-3 h-3 text-blue-600 dark:text-blue-500" />
                          Lahore HQ
                       </div>
                       <p className="text-[11px] md:text-xs text-slate-500 dark:text-white/40 leading-relaxed font-medium">
                         75 H2 Wapda Town <br />
                         Lahore, Pakistan
                       </p>
                    </div>
      ...
      <footer className="px-4 lg:px-12 py-16 md:py-20 bg-slate-50 dark:bg-[#010101] border-t border-slate-200 dark:border-white/10 relative z-10 w-full overflow-x-hidden">
        <div className="max-w-[1400px] mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-12 gap-12 md:gap-16 mb-16 md:mb-20">
            <div className="col-span-1 md:col-span-4 space-y-6 md:space-y-8">
              ...
              <p className="text-slate-500 dark:text-white/70 max-w-sm text-base md:text-lg leading-relaxed font-medium">
            ...
            <div className="col-span-1 md:col-span-2 space-y-6 md:space-y-8">
              <h5 className="text-[11px] md:text-[12px] font-bold text-slate-900 dark:text-white uppercase tracking-[0.3em] opacity-90">Platform</h5>
            ...
            <div className="col-span-1 md:col-span-2 space-y-6 md:space-y-8">
              <h5 className="text-[11px] md:text-[12px] font-bold text-slate-900 dark:text-white uppercase tracking-[0.3em] opacity-90">Intelligence</h5>
              <ul className="space-y-3 md:space-y-4 text-[11px] md:text-[12px] text-slate-500 dark:text-white/60 uppercase tracking-[0.1em] font-bold">
            ...
            <div className="col-span-1 md:col-span-2 space-y-6 md:space-y-8">
              <h5 className="text-[11px] md:text-[12px] font-bold text-slate-900 dark:text-white uppercase tracking-[0.3em] opacity-90">Network</h5>
              <ul className="space-y-3 md:space-y-4 text-[11px] md:text-[12px] text-slate-500 dark:text-white/60 uppercase tracking-[0.1em] font-bold">
            ...
            <div className="col-span-1 md:col-span-2 space-y-6 md:space-y-8">
              <h5 className="text-[11px] md:text-[12px] font-bold text-slate-900 dark:text-white uppercase tracking-[0.3em] opacity-90">Policy</h5>
              <ul className="space-y-3 md:space-y-4 text-[11px] md:text-[12px] text-slate-500 dark:text-white/60 uppercase tracking-[0.1em] font-bold">
